...
const T = (train, mode, date) => `OCESN${train}${mode}1187_${mode}:TER:FR:Line::L${train}::87000001:87000002:1:1200:${date}`;
const lk = lookupFrom({
  'trips.txt': ['route_id,service_id,trip_id,trip_headsign', `RA,S1,${T(100, 'F', 20260101)},100`, `RA,S2,${T(100, 'F', 20260301)},100`, `RB,S1,${T(200, 'R', 20260101)},200`].join('\n'),
